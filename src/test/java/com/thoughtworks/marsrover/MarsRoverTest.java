...
public class MarsRoverTest {
    ...
    @Test
    public void should_be_able_to_receive_turn_right_command_when_mars_rover_is_facing_S() {
        MarsRover marsRover = new MarsRover(10, 20, "S");
        assertEquals("(10, 20) W", marsRover.receiveCommand("R"));
    }

    @Test
    public void should_be_able_to_receive_turn_right_command_when_mars_rover_is_facing_E() {
        MarsRover marsRover = new MarsRover(10, 20, "E");
        assertEquals("(10, 20) S", marsRover.receiveCommand("R"));
    }

    @Test
    public void should_be_able_to_receive_turn_right_command_when_mars_rover_is_facing_W() {
        MarsRover marsRover = new MarsRover(10, 20, "W");
        assertEquals("(10, 20) N", marsRover.receiveCommand("R"));
    }
}
